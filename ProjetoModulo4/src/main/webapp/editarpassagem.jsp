		...
		<nav class="navbar navbar-expand-lg bg-dark px-3 m-auto ">
			<section class="container-fluid col-lg-md-sm-2">
				<a class="navbar-brand text-white fs-1 px-2 letra  menorletra" href="#"
					title="Link para a página inicial."> <img src="./img/Imagem1.png" height="50"
						class="d-inline-block align-text-bottom menorletra" alt="Um avião entre as nuvens.">Vamos Viajar
				</a>
				...
				<section class="collapse navbar-collapse px-0 mx-0 col-md-sm-9 justify-content-end"
					...
					<ul class="nav letra">
						<li class="nav-item "><a class="nav-link active text-white letracontato" aria-current="page"
								href="passagens" title="Link pra página inicial."> Lista de Passagens</a></li>
					...
					<div class="dropdown">
						...
						<ul class="dropdown-menu  dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
							...
							<li><a class="dropdown-item" href="cadastrocliente.html">Cadastrar
									Cliente</a></li>
							<li><a class="dropdown-item" href="index.html">Visualizar como usuário</a></li>
						</ul>
        ...
        <div class="bg-white d-flex justify-content-center align-items-center vh-100 pb-5">
          <div>
            ...
            <div class="input-group pt-4">
              ...
              <input class="form-control bg-light" type="text" name="num_voo" value="${passagens.num_voo}" placeholder="Número do vôo" required>
            </div>
