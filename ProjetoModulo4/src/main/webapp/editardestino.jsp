...
<body class="body">
	...
	<main class="row justify-content-center ">
		...
		<div class="container">
			...
			<div
				class="bg-white d-flex justify-content-center align-items-center vh-100 pb-5">
				<div>
					<div class="d-flex justify-content-center pt-5 cadastro1"
						style="width: 30rem">
						<img src="img/22646cad-5577-46be-8243-e690ed23ef75.jpeg"
							alt="login-icon" style="height: 4rem" class="pt-1">
					</div>

					<div class="text-center fs-1 letra mb-5">Edite um Destino:</div>

					<form action="destinos-update" class="form-control border-0">
						<div class="input-group pt-4 ">
							<div class="input-group-text">
								<i class="bi bi-person-circle"></i>
							</div>
							<input class="form-control bg-light" type=text name="cidade"
								value="${destinos.cidade}" placeholder="Cidade" required>
						</div>
						...
						<div class="input-group pt-4">
							...
							<input class="form-control bg-light" type="text" name="estado"
								value="${destinos.estado}" placeholder="Estado" required>
						...
						<div class="input-group pt-4">
							...
							<input class="form-control bg-light" type="text" name="pais"
								value="${destinos.pais}" placeholder="País" required>
						</div>
						...
						<div class="input-group pt-4">
							...
							<input class="form-control bg-light" type="text" name="aeroporto"
								value="${destinos.aeroporto}" placeholder="Aeroporto" required>
						</div>
						...
						<div class="input-group pt-4">
							...
							<input class="form-control bg-light" type=text name="promocao"
								value="${destinos.promocao}"
								placeholder="Promoção em porcentagem (só números)" required>
						</div>

						<div class="d-flex">
							<input type="submit" value="Editar o Destino"
								class="btn button text-white w-100  mt-4 fw-semibold shadow-sm fs-5 mx-2">
							<a href="destinos"><input type="button" value="Cancelar"
